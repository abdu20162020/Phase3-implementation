...
public class PostModel {
    ...
    public Vector<Post> reterivemyPost(int userid) {
        // TODO implement here
        Vector<Post> mypost = new Vector<Post>();
     ...
     * @param categoryid
     */
    public Vector<Post> reteriveallPost(int categoryid) {
        // TODO implement here

        Vector<Post> post_ct = new Vector<Post>();
